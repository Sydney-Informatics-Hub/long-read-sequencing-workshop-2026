...
!!! tip "Cross-check against the assembly graph"
    ...
    # The 3rd argument is the ID map that merge_contigs.sh wrote next to your
    # draft assembly; it is used to label the contigs chromosome, plasmid_1, ...
    plassembler_gfa=(plassembler/*_plasmids.gfa)
    "${HOME}/scripts/utilities/combine_bandage_graphs.sh" \
        flye/assembly_graph.gfa \
        "${plassembler_gfa[0]}" \
        draft_assembly.fasta.id_map.txt \
...
Hands-on: Pathogen detection from (direct Nanopore) sequencing data using Galaxy - Foodborne Edition / Pathogen detection from (direct Nanopore) sequencing data using Galaxy - Foodborne Edition / Microbiome. Accessed September 17, 2026. https://training.galaxyproject.org/training-material/topics/microbiome/tutorials/pathogen-detection-from-nanopore-foodborne-data/tutorial.html

Home · ncbi/amr Wiki. Accessed September 17, 2026. https://github.com/ncbi/amr/wiki/

NCBI - Pathogen Detection - NCBI. Accessed September 17, 2026. https://www.ncbi.nlm.nih.gov/pathogens/pathogens_help/#amr

Antimicrobial resistance. Accessed September 17, 2026. https://www.who.int/news-room/fact-sheets/detail/antimicrobial-resistance

Understand – Toolbox – ReAct. Accessed September 17, 2026. https://www.reactgroup.org/toolbox/understand/

Feldgarden M, Brover V, Haft DH, et al. Validating the AMRFinder Tool and Resistance Gene Database by Using Antimicrobial Resistance Genotype-Phenotype Correlations in a Collection of Isolates. Antimicrobial Agents and Chemotherapy. 2019;63(11):e00483-19. doi:10.1128/AAC.00483-19

Roberts LW, Enoch DA, Khokhar F, et al. Long-read sequencing reveals genomic diversity and associated plasmid movement of carbapenemase-producing bacteria in a UK hospital over 6 years. Microbial Genomics. 2023;9(7):mgen001048. doi:10.1099/MGEN.0.001048

Prussing C, Snavely EA, Singh N, et al. Nanopore MinION Sequencing Reveals Possible Transfer of blaKPC–2 Plasmid Across Bacterial Species in Two Healthcare Facilities. Frontiers in Microbiology. 2020;11:569311. doi:10.3389/FMICB.2020.02007/TEXT

Factors affecting bacterial pathogenicity. Accessed September 17, 2026. https://microbenotes.com/factors-affecting-bacterial-pathogenicity/

Jones IA, Joshi LT. Biocide Use in the Antimicrobial Era: A Review. Molecules 2021, Vol 26, Page 2276. 2021;26(8):2276. doi:10.3390/MOLECULES26082276

oschwengers/bakta: Rapid & standardized annotation of bacterial genomes, MAGs & plasmids. Accessed September 17, 2026. https://github.com/oschwengers/bakta

tseemann/prokka: :zap: Rapid prokaryotic genome annotation. Accessed September 17, 2026. https://github.com/tseemann/prokka

tseemann/abricate: :mag_right: Mass screening of contigs for antimicrobial and virulence genes. Accessed September 17, 2026. https://github.com/tseemann/ABRICATE
