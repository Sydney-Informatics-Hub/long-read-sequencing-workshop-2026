...
Run QUAST on your draft assembly FASTA file. Place the output in a new directory called `quast`, and use 4 CPU threads.
...
Run BUSCO on your draft assembly FASTA file using the pre-downloaded bacterial lineage database located at `~/data/ref/busco/bacteria_odb12`. Place the output in a new directory called `busco`, and use 4 CPU threads.
