...
In this exercise, you will run QUAST, BUSCO, and Bandage on the assembly you put together at the end of the [Lesson 6 exercise](./06.plasmids.md#634-add-any-new-plasmids-to-your-assembly) (your `flye` chromosome plus any additional plasmids recovered by `plassembler`), and use each tool's output to judge how complete and reliable that assembly is.
...
Visualise your assembly graph(s) with Bandage. Start with the `flye` assembly graph from [Lesson 5](./05.assembly.md):
