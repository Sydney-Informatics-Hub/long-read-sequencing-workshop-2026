...
We have written a custom script to help you search the PLSDB database that comes with `plassembler` for hits from each of your contigs. You can run this as follows:
...
**Run the `merge_contigs` script to create your complete assembly and name it `draft_assembly.fasta`**
