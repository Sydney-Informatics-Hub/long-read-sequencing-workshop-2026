...
## 1. How MinION opened up sequencing
...
![](assets/01.intro/minion_in_action.png)
*Source: https://nanoporetech.com/products/sequence/minion-in-action*

## 2. Antimicrobial resistance and hospital outbreaks
...
![](assets/01.intro/ontpacbio-seq.jpg)
...
![](assets/01.intro/ontseqminion.webp)
...
![](assets/01.intro/sequencing_devices.png)
*Source: https://nanoporetech.com/products/sequence*

### 5.2. Barcoding and multiplexing
...
![](assets/01.intro/sqk-mlk114-workflow.svg)
...
![](assets/01.intro/read_accuracy_chemistry_evolution.jpg)
...
![](assets/01.intro/read_accuracy_chemistry.jpg)
...
![](assets/01.intro/basecalling.jpg)
...
### 7.1. Different basecalling models
...
![](assets/01.intro/read_accuracy_models.png)
...
![](assets/01.intro/basecallers.png)
...
1. **Basecalling** — raw nanopore signal is converted into FASTQ reads ([Section 7](#7-basecalling)).
...
Agustinho DP, Fu Y, Menon VK, Metcalf GA, Treangen TJ, Sedlazeck FJ. Unveiling microbial diversity: harnessing long-read sequencing technology. Nature Methods 2024 21:6. 2024;21(6):954-966. doi:10.1038/s41592-024-02262-1

Nadeem M, Rizvi AS, Rahman A, Murtaza G. Third-generation nanopore sequencing: advancing real-time pathogen detection and antimicrobial resistance surveillance in food safety applications. The Analyst. 2026;151(8):2121-2134. doi:10.1039/D5AN01028D

González A, Fullaondo A, Odriozola A. Why Are Long-Read Sequencing Methods Revolutionizing Microbiome Analysis? Microorganisms 2025, Vol 13, Page 1861. 2025;13(8):1861. doi:10.3390/MICROORGANISMS13081861

Meyer D, Goettsch W, Spangenberg J, et al. Unlocking the full potential of nanopore sequencing: tips, tricks, and advanced data analysis techniques. Nucleic Acids Research. 2026;54(3):23. doi:10.1093/NAR/GKAG023

Data analysis | Oxford Nanopore Technologies. Accessed September 16, 2026. https://nanoporetech.com/document/data-analysis

From kilobases to “whales”: a short history of ultra-long reads and high-throughput genome sequencing. Accessed September 16, 2026. https://nanoporetech.com/blog/news-blog-kilobases-whales-short-history-ultra-long-reads-and-high-throughput-genome

Nanopore sequencing accuracy | Oxford Nanopore Technologies. Accessed September 16, 2026. https://nanoporetech.com/platform/accuracy
