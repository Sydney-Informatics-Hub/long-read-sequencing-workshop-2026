...
3. By defaul, VS Code will suggest your home folder (`/home/<USERNAME>`), which is the directory we want to open. Press `Enter` to open VS Code in your home directory.
