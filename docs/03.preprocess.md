...
Run filtlong to keep only long reads longer than 1 kb and retain only the top 50% of reads by quality. Run FastQC and NanoPlot on the subsampled file and analyse how the quality statistics changed. Answer the following questions:
