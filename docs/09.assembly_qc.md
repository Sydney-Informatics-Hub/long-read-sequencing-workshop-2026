...
In this exercise, you will run QUAST, BUSCO, and Bandage on the assembly you put together at the end of the [Lesson 7 exercise](./07.plasmids.md#734-add-any-new-plasmids-to-your-assembly) (your `flye` chromosome plus any additional plasmids recovered by `plassembler`), and use each tool's output to judge how complete and reliable that assembly is.
